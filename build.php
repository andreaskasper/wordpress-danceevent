...
$rootPath = __DIR__."/src/goo1-danceevent/";

$str = file_get_contents(__DIR__."/src/goo1-danceevent/goo1-danceevent.php");
...
file_put_contents(__DIR__."/src/goo1-danceevent/goo1-danceevent.php", $str);
echo("Version: ".$m2["v"]." => ".$m["v"].PHP_EOL);

// Initialize archive object
$zip = new ZipArchive();
$zip->open('dist/goo1-danceevent.zip', ZipArchive::CREATE | ZipArchive::OVERWRITE);
...
foreach ($files as $name => $file)
{
    ...
    if (!$file->isDir())
    {
        ...
        $zip->addFile($filePath, "goo1-danceevent/".$relativePath);
    }
}
